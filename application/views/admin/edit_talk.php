		...
		<div class="row">
			...
			<div class="span9">
				...
				<a id="deletebutton" class="btn btn-danger activate-tooltip" title="Delete the mp3 on the server and all the talk details from the database. CANNOT BE UNDONE!" style="float:right" href="<?php echo base_url('/admin/deletetalk/'.$talk[0]->id); ?>">Delete Talk</a>
