...
<div id="cover">
	<div class="header">
		<div class="metadata">
			<h1 class="title"><a href="<?php echo base_url("/talks/talk/".$talk->id);?>" title="<?php echo $talk->title;?>"><?php echo $talk->title;?></a></h1><br>
			<h2 class="series truncate"><?php echo $talk->seriestitle;?></h2><br>
	...
	<div id="links">
		...
		<a href="<?php echo base_url("/talks/talk/".$talk->id);?>">Listen to this talk on DICCU Talks</a>
	</div>
<?php if($talk_exists) : ?>
<div id="player">
