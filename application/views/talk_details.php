		...
		<div class="tab-pane<?= $talk[0]->video ? ' active' : '' ?>" id="video">
			<?php if($talk[0]->video) :?>
				...
				<?php if (preg_match("/(?:https?:\/\/(?:www.)?youtube.com\/watch\?(?:[a-zA-Z0-9_=&]*&)?v=)([a-zA-Z0-9_-]*)/", $talk[0]->video, $matches)) :?>
					<iframe id="ytPlayer" class="embed-responsive-item" src="//www.youtube.com/embed/<?php echo $matches[1]; ?>?enablejsapi=1" frameborder="0" allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe>
